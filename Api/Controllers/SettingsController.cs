...
{
    private ISettingsModule _Module;

    public SettingsController(ISettingsModule module) : base(module)
    {
        _Module = module;
    }
    ...
    public async Task<ActionResult> GetBaseSettings()
    {
        var result = await _Module.GetBaseSettings();
