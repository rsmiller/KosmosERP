...
public class APInvoiceHeaderEditCommand : DataCommand
{
    ...
    public List<APInvoiceLineEditCommand> ap_edit_invoice_lines { get; set; } = new List<APInvoiceLineEditCommand>();
    public List<APInvoiceLineCreateCommand> ap_create_invoice_lines { get; set; } = new List<APInvoiceLineCreateCommand>();
}
