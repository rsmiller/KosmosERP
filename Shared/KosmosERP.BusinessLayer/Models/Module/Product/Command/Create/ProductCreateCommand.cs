...
namespace KosmosERP.BusinessLayer.Models.Module.Product.Command.Create;
...
public class ProductCreateCommand : DataCommand
{
    ...
    public int manufacture_time_minutes{ get; set; } = 0;
    public bool is_manufactured { get; set; } = false;
