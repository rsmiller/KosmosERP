...
public class SquarePaymentProvider : IPaymentProvider
{
    ...
    public SquarePaymentProvider(IPaymentProviderSettings settings)
    {
        _Settings = settings;
    }
    ...
    public Task<Response<PaymentProviderInvoiceDto>> CompleteInvoice(string invoice_external_id, string payment_external_id)
    {
        throw new NotImplementedException();
    }
