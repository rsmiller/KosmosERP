        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    payment_terms = table.Column<int>(type: "int", nullable: false),
                    invoice_date = table.Column<DateOnly>(type: "date", nullable: false),
                    invoice_due_date = table.Column<DateOnly>(type: "date", nullable: false),
                    invoice_total = table.Column<decimal>(type: "decimal(14,3)", precision: 14, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    on_order = table.Column<int>(type: "int", nullable: false),
                    guid = table.Column<string>(type: "longtext", nullable: false),
                    created_on = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP(6)"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    planned_complete_date = table.Column<DateOnly>(type: "date", nullable: false),
                    actual_completed_on = table.Column<DateOnly>(type: "date", nullable: true),
                    is_complete = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_production_order_liness", x => x.id);
                    table.ForeignKey(
                        name: "FK_production_order_liness_order_lines_order_line_id",
                        column: x => x.order_line_id,
                        principalTable: "order_lines",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_production_order_liness_production_order_headers_production_~",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "id", "approve_by_id", "friendly_name", "guid", "internal_name", "requires_approval" },
                values: new object[,]
                {
                    { 1, null, "AR Invoice", "6a98c7ed-1478-4684-9070-9f60f42b9c2c", "ar_invoice", false },
                    { 2, null, "AP Invoice", "de6bd73f-88bd-4862-8a7b-0a618396641f", "ap_invoice", false },
                    { 3, null, "Tax Exempt Form", "b86bfbe7-d7ed-4be0-9ff2-06a370e48553", "tax_exempt_form", false },
                    { 4, null, "Customer EIN/TIN Form", "49f4800d-673b-4ae8-aff3-2b700fb1df3b", "customer_formation_form", false }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_production_order_headers_status_id",
                table: "production_order_headers",
                column: "status_id");

            migrationBuilder.CreateIndex(
                name: "IX_production_order_liness_order_line_id",
                table: "production_order_liness",
                column: "order_line_id");

            migrationBuilder.CreateIndex(
                name: "IX_production_order_liness_production_order_header_id",
                table: "production_order_liness",
                column: "production_order_header_id");

            migrationBuilder.CreateIndex(
                name: "IX_production_order_liness_status_id",
                table: "production_order_liness",
                column: "status_id");
