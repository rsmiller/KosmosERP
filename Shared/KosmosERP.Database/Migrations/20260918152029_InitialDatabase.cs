        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    general_email = table.Column<string>(type: "varchar(175)", maxLength: 175, nullable: true),
                    accounting_email = table.Column<string>(type: "varchar(175)", maxLength: 175, nullable: true),
                    ...
                    external_id = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: true),
                    payment_external_id = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: true),
                    guid = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    is_deleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    created_on = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP(6)"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    queue = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false),
                    body = table.Column<string>(type: "longtext", nullable: false),
                    read = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    read_on = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    guid = table.Column<string>(type: "varchar(255)", nullable: false),
                    is_deleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    created_on = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP(6)"),
                    created_on_timezone = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    order_header_id = table.Column<int>(type: "int", nullable: false),
                    ar_header_id = table.Column<int>(type: "int", nullable: false),
                    payment_number = table.Column<int>(type: "int", nullable: false, defaultValue: 210000),
                    payment_amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    transaction_method = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    transaction_id = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true),
                    transaction_date = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    transaction_status = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    confirmation_code = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true),
                    payment_receipt = table.Column<string>(type: "longtext", nullable: true),
                    payment_processor = table.Column<string>(type: "longtext", nullable: true),
                    guid = table.Column<string>(type: "varchar(255)", nullable: false),
                    is_deleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    created_on = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP(6)"),
                    created_on_timezone = table.Column<string>(type: "longtext", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_payments_order_header_id", x => x.order_header_id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    company_name = table.Column<string>(type: "longtext", nullable: false),
                    company_address1 = table.Column<string>(type: "longtext", nullable: true),
                    company_address2 = table.Column<string>(type: "longtext", nullable: true),
                    company_city = table.Column<string>(type: "longtext", nullable: true),
                    company_state = table.Column<string>(type: "longtext", nullable: true),
                    company_zip = table.Column<string>(type: "longtext", nullable: true),
                    company_country = table.Column<string>(type: "longtext", nullable: true),
                    company_phone = table.Column<string>(type: "longtext", nullable: true),
                    company_ar_email = table.Column<string>(type: "longtext", nullable: true),
                    company_ap_email = table.Column<string>(type: "longtext", nullable: true),
                    company_general_email = table.Column<string>(type: "longtext", nullable: true),
                    company_website = table.Column<string>(type: "longtext", nullable: true),
                    tax_id = table.Column<string>(type: "longtext", nullable: true),
                    fiscal_year_start = table.Column<string>(type: "longtext", nullable: true),
                    guid = table.Column<string>(type: "varchar(255)", nullable: false),
                    is_deleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    created_on = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP(6)"),
                    created_on_timezone = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    customer_id = table.Column<int>(type: "int", nullable: false),
                    credit_memo_number = table.Column<int>(type: "int", nullable: false),
                    ...
                    memo = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true),
                    ar_invoice_header_id = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_credit_memo_headers", x => x.id);
                    table.ForeignKey(
                        name: "FK_credit_memo_headers_customers_customer_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    guid = table.Column<string>(type: "varchar(255)", nullable: false),
                    manufacture_time_minutes = table.Column<int>(type: "int", nullable: false),
                    is_manufactured = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    gl_account_id = table.Column<string>(type: "longtext", nullable: false),
                    description = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_credit_memo_lines_credit_memo_headers_credit_memo_header_id",
                        column: x => x.credit_memo_header_id,
                        principalTable: "credit_memo_headers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    planned_complete_date = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    billing_subscription_id = table.Column<int>(type: "int", nullable: false),
                    order_header_id = table.Column<int>(type: "int", nullable: true),
                    ar_invoice_header_id = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_subscription_entries", x => x.id);
                    table.ForeignKey(
                        name: "FK_subscription_entries_ar_invoice_headers_ar_invoice_header_id",
                        column: x => x.ar_invoice_header_id,
                        principalTable: "ar_invoice_headers",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_subscription_entries_order_headers_order_header_id",
                        column: x => x.order_header_id,
                        principalTable: "order_headers",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_subscription_entries_payments_payment_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    customer_id = table.Column<int>(type: "int", nullable: false),
                    order_header_id = table.Column<int>(type: "int", nullable: false),
                    subscription_number = table.Column<int>(type: "int", nullable: false, defaultValue: 10000),
                    quantity = table.Column<int>(type: "int", nullable: false),
                    price = table.Column<decimal>(type: "decimal(14,3)", precision: 14, scale: 3, nullable: false),
                    tax = table.Column<decimal>(type: "decimal(14,3)", precision: 14, scale: 3, nullable: false),
                    cycle_days = table.Column<int>(type: "int", nullable: false),
                    start_date = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    next_date = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    end_date = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    guid = table.Column<string>(type: "varchar(255)", nullable: false),
                    is_deleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    created_on = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP(6)"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_subscriptions_order_headers_order_header_id",
                        column: x => x.order_header_id,
                        principalTable: "order_headers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_credit_memo_headers_ar_invoice_header_id",
                table: "credit_memo_headers",
                column: "ar_invoice_header_id");

            migrationBuilder.CreateIndex(
                name: "IX_credit_memo_headers_customer_id",
                table: "credit_memo_headers",
                column: "customer_id");

            migrationBuilder.CreateIndex(
                name: "IX_credit_memo_headers_guid",
                table: "credit_memo_headers",
                column: "guid");

            migrationBuilder.CreateIndex(
                name: "IX_credit_memo_headers_order_header_id",
                table: "credit_memo_headers",
                column: "order_header_id");

            migrationBuilder.CreateIndex(
                name: "IX_credit_memo_lines_ar_invoice_line_id",
                table: "credit_memo_lines",
                column: "ar_invoice_line_id");

            migrationBuilder.CreateIndex(
                name: "IX_credit_memo_lines_credit_memo_header_id",
                table: "credit_memo_lines",
                column: "credit_memo_header_id");

            migrationBuilder.CreateIndex(
                name: "IX_credit_memo_lines_guid",
                table: "credit_memo_lines",
                column: "guid");

            migrationBuilder.CreateIndex(
                name: "IX_credit_memo_lines_order_line_id",
                table: "credit_memo_lines",
                column: "order_line_id");

            migrationBuilder.CreateIndex(
                name: "IX_credit_memo_lines_product_id",
                table: "credit_memo_lines",
                column: "product_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_message_queue_guid",
                table: "message_queue",
                column: "guid");

            migrationBuilder.CreateIndex(
                name: "IX_message_queue_queue",
                table: "message_queue",
                column: "queue");

            migrationBuilder.CreateIndex(
                name: "IX_message_queue_read",
                table: "message_queue",
                column: "read");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_payments_order_header_id",
                table: "payments",
                column: "order_header_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_subscription_entries_ar_invoice_header_id",
                table: "subscription_entries",
                column: "ar_invoice_header_id");

            migrationBuilder.CreateIndex(
                name: "IX_subscription_entries_guid",
                table: "subscription_entries",
                column: "guid");

            migrationBuilder.CreateIndex(
                name: "IX_subscription_entries_order_header_id",
                table: "subscription_entries",
                column: "order_header_id");

            migrationBuilder.CreateIndex(
                name: "IX_subscription_entries_payment_id",
                table: "subscription_entries",
                column: "payment_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_subscriptions_order_header_id",
                table: "subscriptions",
                column: "order_header_id");

            migrationBuilder.CreateIndex(
                name: "IX_subscriptions_subscription_number",
                table: "subscriptions",
