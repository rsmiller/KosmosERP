...
public interface IBaseERPModule
{
    ...
    Task<bool> HasPermission(int calling_user_id, string token, bool read = false, bool write = false, bool edit = false, bool delete = false);
...
public class BaseERPModule : IBaseERPModule, IDisposable
{
    ...
    public async Task<UserPermissionsSet> GetUserPermissions(int calling_user_id)
    {
        ...
        try
        {
            var assigned_module_permissions = await (from ur in _ERPDbContext.UserRoles
                                                        ...
                                                        && rp.module_id == this.ModuleIdentifier.ToString()
    ...
    public async Task<bool> HasPermission(int calling_user_id, string token, bool read = false, bool write = false, bool edit = false, bool delete = false)
    {
