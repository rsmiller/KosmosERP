...
public class APInvoiceModuleTests : BaseTestModule<APInvoiceModule>, IModuleTest
{
    ...
    {
        var the_module = new APInvoiceModule(base._Context);
    ...
    {
        var read_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == APInvoicePermissions.Read);
    ...
    {
        var create_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == APInvoicePermissions.Create);
        var role = await _Context.Roles.Where(m => m.name == "Module Admin").FirstAsync();
    ...
    {
        var edit_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == APInvoicePermissions.Edit);
        var role = await _Context.Roles.Where(m => m.name == "Module Admin").FirstAsync();
    ...
    {
        var delete_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == APInvoicePermissions.Delete);
        var role = await _Context.Roles.Where(m => m.name == "Module Admin").FirstAsync();
    ...
    public async Task Delete()
    {
        ...
        Assert.Zero(delete_result.Data.ap_invoice_lines.Count());
    ...
    public async Task Find()
    {
        ...
        var results = await _Module.Find(
                        ...
                        new APInvoiceHeaderFindCommand() { calling_user_id = 1, token = _SessionId, wildcard = "D1230" });
    ...
    public async Task GetAssociations()
    {
        ...
        var sales_order_create_result = await _Module.Create(new APInvoiceHeaderCreateCommand()
        {
            calling_user_id = 1,
            token = _SessionId,
            vendor_id = _Vendor.id,
        ...
        Assert.IsTrue(sales_order_create_result.Success);
        Assert.IsNotNull(sales_order_create_result.Data);

        var sales_order_results = await _Module.GetAssociations(new APInvoiceAssociationsFindCommand()
        {
            calling_user_id = 1,
            token = _SessionId,
            ap_invoice_object_id = sales_order_create_result.Data.id,
        });

        Assert.IsNotNull(sales_order_results);
        Assert.IsNotNull(sales_order_results.Data);
        Assert.NotZero(sales_order_results.Data.Count());
        Assert.That(sales_order_results.Data[0].is_sales_order == true);
        Assert.NotZero(sales_order_results.Data[0].additional_data.Count());
        ...
        Assert.IsTrue(ar_invoice_create_result.Success);
        Assert.IsNotNull(ar_invoice_create_result.Data);
        ...
        Assert.IsNotNull(ar_ionvoice_results);
        Assert.IsNotNull(ar_ionvoice_results.Data);
        Assert.NotZero(ar_ionvoice_results.Data.Count());
        Assert.That(ar_ionvoice_results.Data[0].is_ar_invoice == true);
        Assert.NotZero(ar_ionvoice_results.Data[0].additional_data.Count());
    }
    ...
    public async Task AssociateReceivedPO()
    {
        ...
        Assert.IsTrue(associate_results.Success);
        Assert.IsNotNull(associate_results.Data);
        Assert.IsNotNull(associate_results.Data.purchase_order_receive_id);
    }
    ...
    public async Task AssociateHeaderObject()
    {
        ...
        Assert.IsNotNull(associate_response);
        Assert.IsNotNull(associate_response.Data);
        Assert.NotZero(associate_response.Data.ap_invoice_lines.Count());
    ...
    private void ValidateMostDtoFields(Response<APInvoiceHeaderDto> result)
    {
        ...
        Assert.IsNotEmpty(result.Data.invoice_number);
        Assert.IsNotEmpty(result.Data.memo);
    ...
    private void ValidateMostListFields(APInvoiceHeaderListDto result)
    {
        ...
        Assert.IsNotEmpty(result.invoice_number);
        Assert.IsNotEmpty(result.memo);
