...
public class LeadModuleTests : BaseTestModule<LeadModule>, IModuleTest
{
    ...
    {
        var the_module = new LeadModule(base._Context);
    ...
    {
        var read_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == LeadPermissions.Read);
    ...
    {
        var create_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == LeadPermissions.Create);
        var role = await _Context.Roles.Where(m => m.name == "Module Admin").FirstAsync();
    ...
    {
        var edit_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == LeadPermissions.Edit);
        var role = await _Context.Roles.Where(m => m.name == "Module Admin").FirstAsync();
    ...
    {
        var delete_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == LeadPermissions.Delete);
        var role = await _Context.Roles.Where(m => m.name == "Module Admin").FirstAsync();
    ...
    public async Task Find()
    {
        ...
        var results = await _Module.Find(
                        ...
                        new LeadFindCommand() { calling_user_id = 1, token = _SessionId, wildcard = "Susan" });
    ...
    private void ValidateMostDtoFields(Response<LeadDto> result)
    {
        ...
        Assert.IsNotEmpty(result.Data.company_name);
        ...
        Assert.IsNotEmpty(result.Data.address_line1);
        Assert.IsNotEmpty(result.Data.address_line2);
        Assert.IsNotEmpty(result.Data.city);
        Assert.IsNotEmpty(result.Data.state);
        Assert.IsNotEmpty(result.Data.zip);
    ...
    private void ValidateMostListFields(LeadListDto result)
    {
        ...
        Assert.IsNotEmpty(result.company_name);
        ...
        Assert.IsNotEmpty(result.address_line1);
        Assert.IsNotEmpty(result.address_line2);
        Assert.IsNotEmpty(result.city);
        Assert.IsNotEmpty(result.state);
        Assert.IsNotEmpty(result.zip);
