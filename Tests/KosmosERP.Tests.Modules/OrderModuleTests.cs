...
public class OrderModuleTests : BaseTestModule<OrderModule>, IModuleTest
{
    ...
    {
        var the_module = new OrderModule(base._Context, new MockMessagePublisher(new MessagePublisherSettings()));
    ...
    {
        var read_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == OrderPermissions.Read);
    ...
    {
        var create_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == OrderPermissions.Create);
        var role = await _Context.Roles.Where(m => m.name == "Module Admin").FirstAsync();
    ...
    {
        var edit_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == OrderPermissions.Edit);
        var role = await _Context.Roles.Where(m => m.name == "Module Admin").FirstAsync();
    ...
    {
        var delete_permission = await _Context.ModulePermissions.FirstAsync(m => m.module_id == _Module.ModuleIdentifier.ToString() && m.internal_permission_name == OrderPermissions.Delete);
        var role = await _Context.Roles.Where(m => m.name == "Module Admin").FirstAsync();
    ...
    public async Task Delete()
    {
        ...
        Assert.Zero(delete_result.Data.order_lines.Count());
    ...
    public async Task Find()
    {
        ...
        var results = await _Module.Find(
                        ...
                        new OrderHeaderFindCommand() { calling_user_id = 1, token = _SessionId, wildcard = "234234443" });
    ...
    public async Task CreateLine()
    {
        ...
        Assert.NotZero(create_result.Data.order_lines.Count());
        Assert.NotZero(create_result.Data.order_lines[0].attributes.Count());
    ...
    private void ValidateMostDtoFields(Response<OrderHeaderDto> result)
    {
        ...
        Assert.NotZero(result.Data.order_number);
        Assert.NotZero(result.Data.customer_id);
        Assert.NotNull(result.Data.order_type);
    ...
    private void ValidateMostListFields(OrderHeaderListDto result)
    {
        ...
        Assert.NotZero(result.order_number);
        Assert.NotZero(result.customer_id);
        Assert.NotNull(result.order_type);
