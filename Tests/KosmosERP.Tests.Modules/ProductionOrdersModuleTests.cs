...
public class ProductionOrderModuleTests : BaseTestModule<ProductionOrderModule>, IModuleTest
{
    ...
    {
        var the_module = new ProductionOrderModule(base._Context);
    ...
    public async Task Edit()
    {
        ...
        Assert.That(result.Data.status_id == edit_command.status_id);
    ...
    public async Task Delete()
    {
        ...
        Assert.Zero(delete_result.Data.production_order_lines.Count());
    ...
    public async Task Find()
    {
        ...
        var results = await _Module.Find(
                        ...
                        new ProductionOrderHeaderFindCommand() { calling_user_id = 1, token = _SessionId, wildcard = _SalesOrderHeader.order_number.ToString() });
    ...
    public async Task CreateLine()
    {
        ...
        Assert.NotZero(create_result.Data.production_order_lines.Count());
        Assert.IsNotNull(create_result.Data.production_order_lines[0].order_line);
        Assert.NotZero(create_result.Data.production_order_lines[0].order_line.attributes.Count());
        ...
        Assert.IsNotNull(create_line_response.Data.order_line);
        Assert.That(create_line_response.Data.quantity == create_command.quantity);
        Assert.That(create_line_response.Data.status_id == create_command.status_id);
    ...
    public async Task EditLine()
    {
        ...
        Assert.IsNotNull(edit_line_response.Data.order_line);
        Assert.That(edit_line_response.Data.quantity == edit_command.quantity);
        Assert.That(edit_line_response.Data.status_id == edit_command.status_id);
    ...
    private void ValidateMostDtoFields(Response<ProductionOrderHeaderDto> result)
    {
        ...
        Assert.NotZero(result.Data.priority_id);
        Assert.NotNull(result.Data.status_id);
    ...
    private void ValidateMostListFields(ProductionOrderHeaderListDto result)
    {
        ...
        Assert.NotZero(result.priority_id);
        Assert.NotNull(result.status_id);
