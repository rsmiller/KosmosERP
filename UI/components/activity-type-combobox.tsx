...
export class ActivityTypeComboboxParams
{
    dbKey: any;
    onChange: any;
    control?: Control<any>;
...
export interface ActivityTypeComboboxRef {
    isValid: () => boolean;
    getValue: () => any;
    clear: () => void;
}
...
const ActivityTypeCombobox = forwardRef<ActivityTypeComboboxRef, ActivityTypeComboboxParams>(
...
export default ActivityTypeCombobox;