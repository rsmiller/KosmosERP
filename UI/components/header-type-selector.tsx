...
export class HeaderTypeSelectorParams
{
    dbKey: any;
    onChange: any;
    control?: Control<any>;
...
export interface HeaderTypeSelectorRef {
    isValid: () => boolean;
    getValue: () => any;
    clear: () => void;
}
...
const HeaderTypeSelectorCombobox = forwardRef<HeaderTypeSelectorRef, HeaderTypeSelectorParams>(
