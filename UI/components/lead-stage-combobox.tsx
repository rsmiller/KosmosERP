...
export class LeadStageComboboxParams
{
    dbKey: any;
    onChange: any;
    control?: Control<any>;
...
export interface LeadStageComboboxRef {
    isValid: () => boolean;
    getValue: () => any;
    clear: () => void;
}

const LeadStageCombobox = forwardRef<LeadStageComboboxRef, LeadStageComboboxParams>(
    ...
    const fetchData = useAsync(async () => {
        await keyValueService.GetDtoByModule("9d624ee2-6433-49f0-bc6c-3e6978e2ac9c", keycloak?.token || "").then((response) =>
        {
...
export default LeadStageCombobox;
