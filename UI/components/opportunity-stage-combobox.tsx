...
export interface OpportunityStageComboboxRef {
    isValid: () => boolean;
    getValue: () => any;
    clear: () => void;
}

const OpportunityStageCombobox = forwardRef<OpportunityStageComboboxRef, OpportunityStageComboboxParams>(
...
OpportunityStageCombobox.displayName = 'OpportunityStageCombobox';

export default OpportunityStageCombobox;