...
export class ProductionStatusComboboxParams
{
    dbKey: any;
    onChange: any;
    control?: Control<any>;
...
export interface ProductionStatusComboboxRef {
    isValid: () => boolean;
    getValue: () => any;
    clear: () => void;
}

const ProductionStatusCombobox = forwardRef<ProductionStatusComboboxRef, ProductionStatusComboboxParams>(
    ...
    const fetchData = useAsync(async () => {
        await keyValueService.GetDtoByModule("f157469e-5e5c-4a5b-b071-89a28b2a0310", keycloak?.token || "").then((response) =>
        {
...
export default ProductionStatusCombobox;
